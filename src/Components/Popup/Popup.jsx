                  ...
                  <div>
                      ...
                      bg-black/50 z-50 backdrop-blur-sm'>
                          ...
                          shadow-md bg-white rounded-md duration-200 w-[300px]'>
                              ...
                              <div className='mt-4'>
                                  <input type="email"
                                      placeholder='Enter Your Email' className='w-full rounded-md
                                  border border-gray-300 dark:border-gray-500 px-2
                                  py-1 mb-4'/>
                                  ...
                                  <div>
                                      ...
                                      p-2 rounded-md' onClick={() =>setShowPopup(false)}>
                                          Login
                                      </button>
                                  </div>
                                  <div className="mt-4">
                                      <p className='text-center'>0r Login With </p>
                                  </div>
                                  <div className='flex justify-center gap-2 mt-2'>
                                  <FaFacebook className='text-3xl 
                                  hover:text-blue-500 duration-200'/>
                                  <FaGoogle className='text-3xl 
                                  hover:text-primary-500 duration-200'/>
                                      </div>
                              </div>
                        </div>
                      </div>
